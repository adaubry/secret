              ...
              <div key={i} className="bg-slate-900 rounded-lg p-4 border border-green-500">
                <div className="flex justify-between items-start mb-3">
                  <div className="flex-1">
                    <p className="text-white font-bold text-base mb-1">{market.question}</p>
                    <div className="flex items-center gap-2">
                      <span className="text-xs text-slate-400">{market.city}</span>
                      <span className={`text-sm font-bold px-2 py-0.5 rounded ${market.side === 'YES' ? 'bg-green-900/50 text-green-400' : 'bg-red-900/50 text-red-400'}`}>
                        {market.side}
                      </span>
                    </div>
                  </div>
                  <div className="text-right ml-4">
                    <p className="text-green-400 font-bold text-xl">{market.safetyScore}</p>
                    <p className="text-xs text-slate-400">safety score</p>
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-3 text-sm">
                  <div>
                    <p className="text-slate-400 text-xs">Expected Profit</p>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-green-400">
                      ...
                      <span className="text-xs font-semibold">Fetching</span>
                    </div>
                  </div>
                </div>
              </div>
