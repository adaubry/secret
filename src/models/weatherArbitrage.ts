...
// Models
const Market = mongoose.model('Market', marketSchema, 'markets');
const TemperatureReading = mongoose.model('TemperatureReading', temperatureReadingSchema, 'temperature_readings');
...
const TradeDecision = mongoose.model('TradeDecision', tradeDecisionSchema, 'trade_decisions');
const CircuitBreaker = mongoose.model('CircuitBreaker', circuitBreakerSchema, 'circuit_breakers');
const PortfolioMetrics = mongoose.model('PortfolioMetrics', portfolioMetricsSchema, 'portfolio_metrics');
